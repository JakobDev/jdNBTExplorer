...
def main() -> None:
    ...
    component.load_file(root_dir / "deploy" / "page.codeberg.JakobDev.jdNBTExplorer.metainfo.xml")
    ...
    with open(root_dir / "jdNBTExplorer" / "data" / "changelog.html", "w", encoding="utf-8", newline="\n") as f:
        f.write(html_text)
